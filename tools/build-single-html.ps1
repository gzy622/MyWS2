[CmdletBinding()]
param(
  [string]$InputPath = 'src\index.html',
...
function Resolve-ProjectPath {
  ...
  if (
    -not $candidate.Equals($projectRoot, [StringComparison]::OrdinalIgnoreCase) -and
...
$html = $html.Replace('<head>', "<head>`n    <!-- Generated by tools/build-single-html.ps1; edit src/ files instead. -->")
