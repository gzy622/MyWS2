 ...
 * Priority: confirm → course highlight/stats/exam/subject/period/slot/grade → people edit/pick → assignment name → assignments → student-record → more → font-size → drawer → seat landscape
 */
