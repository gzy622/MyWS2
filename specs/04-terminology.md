...
| 更多按钮 | `#moreButton` | 顶栏右侧触发器；网格视图中打开姓名字号浮层，其他状态显示占位 Toast。 |
...
| 菜单项 | `.menu-item[data-action]` | 单个占位功能入口。 |
...
| 字号浮层打开态 | `state.fontSizePopoverOpen`、`.font-size-popover.show` | 浮层当前可见；不持久化。 |
